...
export default function ProductoItem({producto, deleteProducto}) {
  ...
  return (
    <div className="flex flex-row bg-gray-100 hover:bg-gray-300 p-4 rounded-md shadow-md font-Arial w-3/4">
      ...
      <div className="flex space-y-4 flex-col items-center h-full mt-4"  >
        <button className="px-3 py-4 bg-cyan-700 text-white rounded active:bg-cyan-800 font-bold"  onClick={()=>setModalEliminar(true)} >
