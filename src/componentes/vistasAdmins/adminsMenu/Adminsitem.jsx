...
export default function AdminsItem({ admin, modalEditar, deleteAdmin}) {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center bg-gray-100 hover:bg-gray-300 p-4 rounded-md shadow-md font-Arial w-1/2">
      ...
      <div className="flex space-x-2">
        ...
        <button className="px-4 py-3 font-bold bg-orange-500 text-white rounded active:bg-orange-600" onClick={()=>setModalEliminar(true)}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
