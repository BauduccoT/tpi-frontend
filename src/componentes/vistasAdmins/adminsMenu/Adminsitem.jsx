...
export default function AdminsItem({ modificar, admin, deleteAdmin}) {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center bg-gray-100 hover:bg-gray-300 p-4 rounded-md shadow-md font-Arial w-1/2">
      ...
      <div className="flex space-x-2">
        <button className="px-4 py-3 font-bold bg-cyan-700 text-white rounded active:bg-cyan-800" onClick={()=>modificar(admin)}>
